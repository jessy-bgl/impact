...
export const HistoryEmptyState = ({ variant }: Props) => {
  ...
  return (
    ...
    >
      {/* Shows the reward rather than describing it: no variant has a
      ...
      {/* Every state moves on from the profile, so all offer the same button
          as the distribution screen, which already words itself for how far
          the profile has come. */}
