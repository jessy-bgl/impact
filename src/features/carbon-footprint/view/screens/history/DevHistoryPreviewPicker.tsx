...
const buttons: { value: DevHistoryPreview; label: string }[] = [
  ...
  { value: "firstSnapshotPending", label: "Attente" },
  { value: "singleSnapshot", label: "1 relevé" },
  { value: "fullHistory", label: "Historique" },
];

/**
 * Development scaffolding, rendered by `DevEmissionsHistory` only. Walks the
 * screen through each of its states without touching the store, so the empty
