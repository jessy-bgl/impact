...
> = {
  transport: FootprintCategoryViewModel.forTransport(0, 0),
  food: FootprintCategoryViewModel.forFood(0, 0),
  housing: FootprintCategoryViewModel.forHousing(0, 0),
  everydayThings: FootprintCategoryViewModel.forEverydayThings(0, 0),
  societalServices: FootprintCategoryViewModel.forSocietalServices(0, 0),
};
...
export const formatDeltaTonnes = (deltaKg: number): string =>
