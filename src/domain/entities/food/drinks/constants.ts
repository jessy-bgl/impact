import { daysInYear } from "@domain/entities/constants";
import { HotDrinksPerWeek } from "@domain/entities/food/drinks/Drinks";
import { MilkType } from "@domain/entities/food/types";
